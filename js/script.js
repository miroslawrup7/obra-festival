...
function countdown() {
    let countDownDate = new Date("2023-06-24T18:00:00").getTime();
    ...
    const x = setInterval(function () {
        ...
        let minutesDesc = document.querySelector(
            ".counter .minutes .description"
        );
        let secondsDesc = document.querySelector(
            ".counter .seconds .description"
        );
        ...
        if (statuteTitle == "REGULAMIN") {
            ...
            (minutes > 1 || minutes === 0) &&
                (minutesDesc.innerText = "minutes");
            seconds === 1 && (secondsDesc.innerText = "minute");
            (seconds > 1 || seconds === 0) &&
                (secondsDesc.innerText = "minutes");
        }
